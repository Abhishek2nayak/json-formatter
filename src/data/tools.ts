...
export const TOOLS: Tool[] = [
  ...
  },
  {
    ...
    name: 'JSON to Code',
    slug: 'json-to-code',
    description: 'Generate TypeScript interfaces, Python dataclasses, Go structs, SQL tables, Rust structs, and C# classes from any JSON.',
    shortDesc: 'Generate typed code from JSON',
    icon: '</>',
    color: 'blue',
    category: 'convert',
    keywords: ['json to typescript', 'json to python', 'json to go struct', 'json to sql', 'json code generator'],
  },
  {
    id: 'mock-generator',
    name: 'Mock Data Generator',
    slug: 'mock-generator',
    description: 'Generate realistic fake JSON test data from a sample. Smart field detection for 50+ patterns.',
    shortDesc: 'Generate realistic fake test data',
    icon: '⚡',
    color: 'purple',
    category: 'validate',
    keywords: ['json mock data', 'fake data generator', 'test data generator', 'faker json'],
  },
  {
    id: 'json-path',
    name: 'JSONPath Explorer',
    slug: 'json-path',
    description: 'Test and run JSONPath expressions on real JSON. See matching values with full path annotations in real-time.',
    shortDesc: 'Query JSON with JSONPath',
    icon: '⟨/⟩',
    color: 'green',
    category: 'validate',
    keywords: ['jsonpath', 'json path', 'jsonpath tester', 'jsonpath online', 'json query'],
  },
];
